...
public:
	...
	// 2D Helpers
	uint32 PushTriangle2D(const Vector3& first, const Vector3& second, const Vector3& third);

	// 3D Helpers
	void	PushTriangle3D(const Vector3& first, const Vector3& second, const Vector3& third);
